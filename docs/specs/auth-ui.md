...
4. **Storefront forgot-password roundtrip** — same as platform but at `pizza-express.localhost:3001/forgot-password` for a previously-signed-up storefront user. Subject reads "Reset your password for Pizza Express".
