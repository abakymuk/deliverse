...
- [0007 — Map Better-Auth fields to our schema, don't rename schema to BA defaults](./0007-ba-mapping-strategy.md)
- [0008 — shadcn primitives + React Hook Form transitive deps](./0008-shadcn-and-form-deps.md)
- [0009 — Email delivery via `packages/emails/`: React Email + Inngest + Resend](./0009-emails-package-shape.md)
- [0010 — Storefront tenant scoping via wrapped Drizzle adapter + factory callback](./0010-tenant-scoping-injection.md)
- [0011 — `@rp/emails` install diff vs. ADR-0009 anticipated set](./0011-emails-install-diff.md)
- [0012 — Storefront, Brand, Tenant, and Food Hall Architecture](./0012-storefront-brand-tenant-food-hall-architecture.md)
